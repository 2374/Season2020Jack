...
public final class Constants {
    ...
    public static final int INDEXER_STAGE_2_LEFT_FRONT_PORT = 17;
    public static final int INDEXER_STAGE_2_LEFT_BACK_PORT = 18;

    public static final int DRIVETRAIN_FRONT_RIGHT_PORT = 1;
    public static final int DRIVETRAIN_FRONT_LEFT_PORT = 2;
